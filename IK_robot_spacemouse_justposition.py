...
def update_goals_with_spacemouse_pitch(xyz_goal, pitch_angle, buttons, gain_translation, gain_pitch):
    dx, dy, dz = sm_data[:3]
...
try:
    while not exit_flag :
        ...
        if translation_zero and rotation_zero and gripper_zero and pitch_zero:
            ...
            xyz_goal, pitch_angle = update_goals_with_spacemouse_pitch(xyz_goal, pitch_angle, buttons, gain_translation, gain_pitch)
